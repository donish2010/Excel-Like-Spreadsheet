...
//////////////////////////////PRIVATE HELPER METHODS /////////////////////////////////////////////
    ...
    private void processCell(CellToken curCellToken, Cell currentCell, String inputFormula) {
        ...
        if (isInteger(inputFormula)) {               
            ...
            spreadsheet.changeCellFormulaAndRecalculate(curCellToken, expTreeTokenStack, inputFormula);         
            ...
            spreadsheet.changeCellFormulaAndRecalculate(curCellToken, empty, inputFormula);            
            currentCell.setExpressionTree(null);           
            currentCell.setFormula(inputFormula);
...
/////////////////////////////// PUBLIC METHODS /////////////////////////////////////////////////////
    ...
    public void setValueAt(Object value, int row, int col) { 
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Out of Bounds! The Cell you are trying "
                                            + "to access does not exsist.", 
                                            "ERROR", JOptionPane.ERROR_MESSAGE);    
            setValueAt(previousFormula, this.row, this.col + 1 );    
                 
        } catch (ArithmeticException ex) {
            JOptionPane.showMessageDialog(null, "Division by Zero! You are trying to divide by zero, "
