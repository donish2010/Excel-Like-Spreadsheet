 ...
 */
public class ExcelLikeGUI extends JPanel implements PropertyChangeListener {
    ...
    public ExcelLikeGUI() {
        ...
        MyTableModel model = new MyTableModel(spreadsheet);
        table = new JTable(model);  
//        table = new JTable(new MyTableModel(spreadsheet));           
        scroll = new JScrollPane(table);       
        formulaBar = new FormulaBar();  
        formulaBar.addPropertyChangeListener(this);
    ...
    private class Selected extends MouseInputAdapter {  
        ...
        public void mouseReleased(MouseEvent event) {
            ...
            if (col > 0 && row > -1) { // If not row header...
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (evt.getPropertyName().equals("new")) {       
            ...
            if (table.getSelectedColumn() > 0) {
                ((MyTableModel) table.getModel()).setValueAt(str, table.getSelectedRow(), table.getSelectedColumn());  
            }                      
        }
